...
Variety Solar`,
  ...
  pre_onsite_inspection: {
    subject: "Pre-Onsite Inspection & Deposit Confirmation",
    body: `Dear {{name}},

Thank you for choosing Variety Solar. This email confirms receipt of your deposit for your Solar System with Battery Storage. Please note that your deposit is fully refundable.

Prior to your installation, we require a pre-onsite inspection. To assist us in preparing for your site visit, please provide clear photos of the following:

1. Your switchboard
2. Your electricity metre
3. Your preferred placement location for the battery and inverter

You can reply to this email with the photos attached at your earliest convenience. Once received, we will review and schedule your onsite inspection accordingly.

If you have any questions, please don't hesitate to contact our office on 1300 617 689.

Kind regards,
George Fotopoulos
Variety Solar Pty Ltd
Office: 1300 617 689
Email: george@varietysolar.com.au
Web: www.varietysolar.com.au`,
  },
};
