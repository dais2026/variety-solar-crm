...
async function appendLeadToSheet(lead: {
  ...
  // F: Lead Source, G: Product, H: Discovery/Outcome, I: Status, J: Sale Status,
  // K: Notes (manual notes), L: REQUESTED SUMMARIES (Solar Quotes data)
  const row = [
    ...
    "Pending",           // I: Status
    "",                  // J: Sale Status
    "",                  // K: NOTES (left empty for manual notes)
    lead.notes,          // L: REQUESTED SUMMARIES (Solar Quotes data: bill, system size, etc.)
  ];
