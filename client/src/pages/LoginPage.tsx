    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Variety Solar CRM</h1>
        ...
        <button
          onClick={googleLogin}
          className="w-full py-3 border border-gray-200 rounded-lg font-medium hover:bg-gray-50 flex items-center justify-center gap-2"
        >
